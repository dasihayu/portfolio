<section class="py-20 bg-white dark:bg-gray-900 transition-colors duration-300">
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mb-16 space-y-4">
            <span class="text-blue-600 dark:text-blue-400 font-medium">Testimonials</span>
            <h2 class="text-4xl font-bold text-gray-900 dark:text-white">What Clients Say</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @forelse($testimonials as $testimonial)
                <div
                    class="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-xl transition duration-300">
