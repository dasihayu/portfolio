    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-col md:flex-row items-center justify-between gap-16">
            ...
            <div class="md:w-1/2 space-y-6">
                <span class="text-blue-600 dark:text-blue-400 font-medium">👋 Welcome to my portfolio</span>
                ...
                <div class="flex gap-4">
                    <a href="{{ route('projects.index') }}"
                        class="bg-blue-600 dark:bg-blue-500 text-white px-8 py-4 rounded-lg hover:bg-gray-900 dark:hover:bg-gray-700 transition duration-300 font-medium">
                        View Projects
                    </a>
                    <a href="{{ route('contact.index') }}"
                        class="border-2 border-gray-800 dark:border-gray-300 text-gray-800 dark:text-gray-300 px-8 py-4 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-700 hover:text-white transition duration-300 font-medium">
                        Contact Me
                    </a>
                </div>
                <!-- Social Links -->
            ...
            <div class="md:w-1/2 flex justify-end">
                <img src="{{ asset('assets/profile.jpg') }}" alt="Hero Image"
                    class="rounded-2xl shadow-2xl dark:shadow-blue-500/20 w-3/4 hover:scale-105 transition duration-500">
            </div>
        </div>
    </div>
</section>
