        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-16">
            ...
            <div class="md:w-1/2 space-y-6">
                ...
                <div class="flex gap-6 pt-6">
                    <a href="https://github.com/dasihayu" target="blank" class="text-gray-600 hover:text-blue-600">
                    ...
                    <a href="https://www.linkedin.com/in/dasi-hayupermana-b96882263/" target="blank" class="text-gray-600 hover:text-blue-600">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path
            ...
            <div class="md:w-1/2 flex justify-end">
                <img src="{{ asset('assets/profile.jpg') }}" alt="Hero Image"
                    class="rounded-2xl shadow-2xl w-3/4 hover:scale-105 transition duration-500">
            </div>
        </div>
    </div>
</section>
