                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex gap-4">
                            ...
                            <a href="https://www.linkedin.com/in/dasi-hayupermana-b96882263/" target="_blank"
                                class="inline-flex items-center px-6 py-3 border-2 border-blue-600 text-blue-600 font-medium rounded-lg hover:bg-blue-600 hover:text-white transition duration-300">
                                Connect on LinkedIn
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-lg">
                            ...
                            <div class="flex flex-wrap gap-2">
                                @foreach (['HTML/CSS', 'JavaScript', 'Vue.js', 'React', 'TailwindCSS'] as $skill)
                                    <span
                                        class="px-3 py-1 bg-blue-100 text-blue-600 rounded-full text-sm">{{ $skill }}</span>
                                @endforeach
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <div class="space-y-8">
                        <div class="bg-white rounded-2xl p-6 shadow-lg">
                            ...
                            <p class="text-gray-600">Building modern web applications for clients using Laravel, Vue.js, and
                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-lg">
                            ...
                            <p class="text-gray-600">Developed and maintained web applications using Laravel and Vue.js.
                                Collaborated with team members to deliver high-quality solutions.</p>
                        </div>
                    </div>
                </div>
            </div>
