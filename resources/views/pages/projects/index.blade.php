                ...
                @forelse ($projects as $project)
                    <div
                        ...
                        <div class="relative group">
                            ...
                            <div
                                class="absolute inset-0 bg-blue-600 dark:bg-blue-500 bg-opacity-75 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300">
                                <div class="flex gap-4">
                                    @if ($project->demo_url)
                                        <a href="{{ $project->demo_url }}" target="_blank"
                                            class="bg-white dark:bg-gray-800 p-3 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition duration-300">
