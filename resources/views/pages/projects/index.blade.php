                ...
                @foreach ($projects as $project)
                    <div class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300">
                        <div class="relative group">
                            <img src="{{ asset('storage/' . $project->image_url) }}" alt="Project 1" class="w-full">
                            <div
                                ...
                                <div class="flex gap-4">
                                    <a href="{{ $project->demo_url }}" class="bg-white p-3 rounded-full hover:bg-gray-100">
                                    ...
                                    <a href="{{ $project->github_url }}" class="bg-white p-3 rounded-full hover:bg-gray-100">
