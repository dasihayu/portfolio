    ...
    <nav class="mx-auto px-48 py-4 sticky top-0 bg-gray-50 z-10">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center gap-4">
                ...
                <button
                    class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition duration-300">Contact
                    Me</button>
            </div>
        </div>
    </nav>
    ...
    <footer class="bg-gray-900 text-white py-16">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                <!-- Brand Column -->
                <div class="space-y-4">
                    <h2 class="text-2xl font-bold">Dasihayu</h2>
            ...
            <div class="pt-8 border-t border-gray-800">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    <p class="text-gray-400 text-sm">
                        © 2024 Dasihayu. All rights reserved.
                    </p>
