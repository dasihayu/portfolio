...
<body class="flex flex-col min-h-screen" x-data="{ isOpen: false }">
    <!-- Navbar -->
    <nav class="relative py-6 container mx-auto px-4">
        <div class="flex justify-between items-center">
            ...
            <div class="hidden lg:flex items-center space-x-8">
                <div class="flex space-x-4 text-base font-bold">
                    <a href="/about" class="hover:text-gray-600 transition-colors">About Me</a>
                    <a href="/projects" class="hover:text-gray-600 transition-colors">Projects</a>
                    <a href="/contact" class="hover:text-gray-600 transition-colors">Contact Me</a>
                </div>
                <button
        ...
        <div class="lg:hidden absolute top-full left-0 right-0 bg-white shadow-lg rounded-lg mt-2 py-4 px-4"
            ...
            <div class="flex flex-col space-y-4">
                <a href="/about" class="text-base font-bold hover:text-gray-600 transition-colors">About Me</a>
                <a href="/skills" class="text-base font-bold hover:text-gray-600 transition-colors">Skills</a>
                <a href="/projects" class="text-base font-bold hover:text-gray-600 transition-colors">Projects</a>
                <a href="/contact" class="text-base font-bold hover:text-gray-600 transition-colors">Contact Me</a>
                <button
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                ...
                <div class="space-y-4 text-center sm:text-left">
                    ...
                    <p class="text-gray-400 text-sm md:text-base">Building digital products, brands, and experiences.
                    </p>
                ...
                <div class="space-y-4 text-center sm:text-left">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li>
                            <a href="/projects" class="text-gray-400 hover:text-white transition-colors block py-1">
                                Projects
                            </a>
                        </li>
                        <li>
                            <a href="/contact" class="text-gray-400 hover:text-white transition-colors block py-1">
                                Contact
                            </a>
                        </li>
                    </ul>
