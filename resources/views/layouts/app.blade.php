            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-4">
                        <a href="https://github.com/dasihayu" target="_blank" class="text-gray-400 hover:text-white transition duration-300">
                        ...
                        <a href="https://www.linkedin.com/in/dasi-hayupermana-b96882263/" target="_blank" class="text-gray-400 hover:text-white transition duration-300">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
